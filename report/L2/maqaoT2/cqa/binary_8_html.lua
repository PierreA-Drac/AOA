  ...
  paths = {
    {
      ...
      expert = {
        ...
        },
        {
          ...
          txt = "<table><tr><td>Front-end</td><td>2.50</td></tr><tr><td>Dispatch</td><td>2.00</td></tr><tr><td>Data deps.</td><td>1.00</td></tr><tr><td>Overall L1</td><td>2.50</td></tr></table>",
        },
        {
        ...
        },
        {
          ...
          txt = "Assuming all data fit into the L1 cache, each iteration of the binary loop takes 2.50 cycles. At this rate:\n<ul><li>7% of peak load performance is reached (4.80 out of 64.00 bytes loaded per cycle (GB/s @ 1GHz))</li><li>10% of peak store performance is reached (3.20 out of 32.00 bytes stored per cycle (GB/s @ 1GHz))</li></ul>",
        },
        {
