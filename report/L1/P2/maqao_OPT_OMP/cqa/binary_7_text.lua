_cqa_text_report = {
  paths = {
    {
      ...
      expert = {
        ...
        {
          title = "Back-end",
          txt = "       | P0   | P1   | P2   | P3   | P4   | P5   | P6   | P7\n--------------------------------------------------------------\nuops   | 1.00 | 0.50 | 2.00 | 2.00 | 6.00 | 0.50 | 1.00 | 2.00\ncycles | 1.00 | 0.50 | 2.00 | 2.00 | 6.00 | 0.50 | 1.00 | 2.00\n\nCycles executing div or sqrt instructions: NA\nLongest recurrence chain latency (RecMII): 1.00\n",
        },
        {
      ...
      gain = {
        ...
        },
        {
          ...
          txt = "Performance is limited by writing data to caches/RAM (the store unit is a bottleneck).\n\nBy removing all these bottlenecks, you can lower the cost of an iteration from 6.00 to 2.17 cycles (2.77x speedup).\n",
        },
      },
      potential = {
      },
  ...
  common = {
    header = {
      "The loop is defined in /home/pierre/Bureau/AOA/kernel.c:138-139.\n",
