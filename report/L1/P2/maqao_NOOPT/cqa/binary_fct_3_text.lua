  ...
  paths = {
    ...
    },
    {
      ...
      expert = {
        ...
        {
          title = "Back-end",
          txt = "       | P0   | P1   | P2   | P3   | P4    | P5   | P6   | P7\n---------------------------------------------------------------\nuops   | 5.25 | 5.25 | 7.83 | 7.50 | 11.00 | 5.25 | 5.25 | 7.67\ncycles | 5.25 | 5.25 | 7.83 | 7.50 | 11.00 | 5.25 | 5.25 | 7.67\n\nCycles executing div or sqrt instructions: NA\n",
        },
        {
          title = "Cycles summary",
          txt = "Front-end : 7.67\nDispatch  : 11.00\nOverall L1: 11.00\n",
    ...
    },
    {
      ...
      expert = {
        ...
        {
          title = "Back-end",
          txt = "       | P0   | P1   | P2   | P3   | P4    | P5   | P6   | P7\n---------------------------------------------------------------\nuops   | 5.25 | 5.25 | 7.00 | 7.00 | 10.00 | 5.25 | 5.25 | 7.00\ncycles | 5.25 | 5.25 | 7.00 | 7.00 | 10.00 | 5.25 | 5.25 | 7.00\n\nCycles executing div or sqrt instructions: NA\n",
        },
        {
          title = "Cycles summary",
          txt = "Front-end : 7.33\nDispatch  : 10.00\nOverall L1: 10.00\n",
